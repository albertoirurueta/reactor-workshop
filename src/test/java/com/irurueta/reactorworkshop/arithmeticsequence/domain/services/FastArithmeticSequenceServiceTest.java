...
public class FastArithmeticSequenceServiceTest {

    private static final int MAX = 100;

    @Test
    public void class_hasServiceAnnotation() {
        assertNotNull(TestUtils.getClassAnnotation(FastArithmeticSequenceService.class, Service.class));
    }

    @Test
    public void class_extendsFromArithmeticSequenceService() {
        assertTrue(ArithmeticSequenceService.class.isAssignableFrom(FastArithmeticSequenceService.class));
    }
